...
export interface ApiCompanyBackgroundCompanyBackground
  ...
  info: {
    displayName: 'CompanyBackground';
    pluralName: 'company-backgrounds';
    singularName: 'company-background';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::company-background.company-background'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ...
    txt10: Schema.Attribute.Text;
    txt11: Schema.Attribute.Text;
    txt12: Schema.Attribute.Text;
    txt13: Schema.Attribute.Text;
    txt14: Schema.Attribute.Text;
    txt15: Schema.Attribute.Text;
    txt16: Schema.Attribute.Text;
    txt17: Schema.Attribute.Text;
    txt18: Schema.Attribute.Text;
    txt19: Schema.Attribute.Text;
    txt2: Schema.Attribute.Text;
    txt20: Schema.Attribute.Text;
    txt21: Schema.Attribute.Text;
    txt22: Schema.Attribute.Text;
    txt23: Schema.Attribute.Text;
    txt24: Schema.Attribute.Text;
    txt3: Schema.Attribute.Text;
    txt4: Schema.Attribute.Text;
    txt5: Schema.Attribute.Text;
    txt6: Schema.Attribute.Text;
    txt7: Schema.Attribute.Text;
    txt8: Schema.Attribute.Text;
    txt9: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
